...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-sm-12">
        <form action="<?php echo e(route('lead.addlead')); ?>" method="POST">
            <?php echo csrf_field(); ?>
    <div class="row">
      <!-- Requirement Type -->
    ...
    <select name="property_sub_type" id="property_sub_type" class="form-control">
        ...
        <div class="form-group col-md-4">
            ...
            <select name="budget" id="budget" class="form-control">
                ...
                <?php $__currentLoopData = $budget; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pspace/leadactpro.in/resources/views/lead/create.blade.php ENDPATH**/ ?>