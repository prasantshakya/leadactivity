...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script> <?php $__env->startSection('content'); ?> <div class="row">
        ...
        <div class="row">
          <div class="col-xxl-7">
            <div class="row">
                ...
                <?php if($leaddata->followup_type=='1'): ?> 
              <!-- Interested Button -->
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="<?php echo e(route('leads.status.interested', ['id' => $leaddata->id])); ?>" method="POST"> <?php echo csrf_field(); ?> <div class="row">
                      
                       <div class="col-md-6 mb-3">
                        <label for="propertyType" class="form-label">Property Type</label>
                         <select name="property_type" id="property_type" class="form-control">
                        <option value="">Select Property Type</option>
                        <option value="residential" <?php echo e(old('property_type', $leaddata->property_type) == 'residential' ? 'selected' : ''); ?>>Residential</option>
                        <option value="commercial" <?php echo e(old('property_type', $leaddata->property_type) == 'commercial' ? 'selected' : ''); ?>>Commercial</option>
                        <option value="industrial" <?php echo e(old('property_type', $leaddata->property_type) == 'industrial' ? 'selected' : ''); ?>>Industrial</option>
                    </select>
                      </div>
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <select name="budget_id" class="form-control"> <?php $__currentLoopData = $budget; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($data->id); ?>"><?php echo e($data->name); ?></option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> </select>
                      </div>
                      ...
                      <?php $__currentLoopData = $source; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="modal fade" id="callbackModal" tabindex="-1" aria-labelledby="callbackModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="callbackForm" action="<?php echo e(route('leads.status.callback', ['id' => $leaddata->id])); ?>" method="POST"> 
                  <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-3">
                      ...
                      <select name="callbackReason" class="form-control" required>
                        <?php $__currentLoopData = $callbackStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($data->id); ?>"><?php echo e($data->name); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
          ...
          <div class="modal fade" id="notInterestedModal" tabindex="-1" aria-labelledby="notInterestedModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="<?php echo e(route('leads.status.notinterested', $leaddata->id)); ?>"> 
                  <?php echo csrf_field(); ?> 
                    ...
                    <div class="row">
                      <div class="col-md-12 mb-3">
                        ...
                        <select name="reason" class="form-control">
                         <?php $__currentLoopData = $notInterestedStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($data->id); ?>"><?php echo e($data->name); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                      </div>
          ...
          <div class="modal fade" id="lostModal" tabindex="-1" aria-labelledby="notInterestedModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="<?php echo e(route('leads.status.lostLead', $leaddata->id)); ?>">
          ...
          <div class="modal fade" id="rescheduleModal" tabindex="-1" aria-labelledby="notInterestedModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="<?php echo e(route('leads.status.taskRescheduled', $leaddata->id)); ?>">
                       <?php echo csrf_field(); ?> 
                       <?php echo method_field('POST'); ?>
                    <!-- This ensures the correct HTTP method -->
                    <div class="row">
          ...
          <!--- Modal for Create Modal Reason ---->
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="<?php echo e(route('leads.status.taskCreate', $leaddata->id)); ?>">
                       <?php echo csrf_field(); ?>
                       <?php echo method_field('POST'); ?>
                    <!-- This ensures the correct HTTP method -->
                    <div class="row">
          ...
          <div class="modal fade" id="wonModal" tabindex="-1" aria-labelledby="notInterestedModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="<?php echo e(route('leads.status.wonLead', $leaddata->id)); ?>">
                       <?php echo csrf_field(); ?> <?php echo method_field('POST'); ?>
                    <!-- This ensures the correct HTTP method -->
                    <div class="row">
                      <div class="col-md-12 mb-3">
              ...
              <div class="card-body">
                ...
                <ul class="list-group mb-4">
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Name:</strong>
                    <span><?php echo e($leaddata->name ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Email:</strong>
                    <span><?php echo e($leaddata->email ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Phone No:</strong>
                    <span><?php echo e($leaddata->phone_no ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Alternative No:</strong>
                    <span><?php echo e($leaddata->alternative_no ?? 'N/A'); ?></span>
                  </li>
                </ul>
                <!-- Property Details -->
                ...
                <ul class="list-group">
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <span><?php echo e($leaddata->unit_no ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Project ID:</strong>
                    <span><?php echo e($leaddata->project->name ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Property Type:</strong>
                    <span><?php echo e($leaddata->property_type ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Property Sub Type:</strong>
                    <span><?php echo e($leaddata->property_subtype ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Requirements:</strong>
                    <span><?php echo e($leaddata->requirements ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Budget ID:</strong>
                    <span><?php echo e($leaddata->budget->name ?? 'N/A'); ?></span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="card-body">
                ...
                <ul class="list-group mb-4">
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <span><?php echo e($leaddata->lead_type ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Sources:</strong>
                    <span><?php echo e($leaddata->source->name ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Created By:</strong>
                    <span><?php echo e($leaddata->created_by ?? 'N/A'); ?></span>
                  </li>
                </ul>
                <!-- Date Information -->
                ...
                <ul class="list-group">
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Date:</strong>
                    <span><?php echo e($leaddata->date ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Created At:</strong>
                    <span><?php echo e($leaddata->created_at ?? 'N/A'); ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Updated At:</strong>
                    <span><?php echo e($leaddata->updated_at ?? 'N/A'); ?></span>
                  </li>
                </ul>
              </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pspace/leadactpro.in/resources/views/lead/view.blade.php ENDPATH**/ ?>