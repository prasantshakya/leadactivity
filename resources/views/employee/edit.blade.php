...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group col-md-6">
    {{ Form::label('team_owner', __('Team Owner'), ['class' => 'form-label']) }}
    <select class="select form-control" id="team_owner" name="team_owner">
        <option value="">{{ __('Select Team Owner') }}</option>
