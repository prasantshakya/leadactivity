...
Route::get('/', [DashboardController::class, 'analytics'])->name('dashboard')->middleware(['XSS']);

Route::get('/analytics', [DashboardController::class, 'analytics'])->name('dashboard.analytics');
Route::get('/user-analytics', [DashboardController::class, 'userAnalytics'])->name('dashboard.useranalytics');
Route::get('/leads/all',[DashboardController::class, 'allleads'])->name('dashboard.allleads');
Route::get('/leads/freshleads',[DashboardController::class, 'freshleads'])->name('dashboard.freshleads');
Route::get('/leads/callback',[DashboardController::class, 'callback'])->name('dashboard.callback');
Route::get('/leads/interested',[DashboardController::class, 'interested'])->name('dashboard.interested');
Route::get('/leads/notinterested',[DashboardController::class, 'notinterested'])->name('dashboard.notinterested');
Route::get('/leads/sitevisit',[DashboardController::class, 'sitevisit'])->name('dashboard.sitevisit');

Route::get('/leads/won', [DashboardController::class, 'wonleads'])->name('dashboard.wonleads');
Route::get('/leads/userleads/{id}/{status}', [DashboardController::class, 'userleads'])->name('dashboard.userleads');
Route::get('leads/substatusleads/{id}/{substatus?}', [DashboardController::class, 'substatusLeads'])->name('dashboard.substatusLeads');
Route::get('/leads/statusleads/{status_id}', [DashboardController::class, 'statusleads'])->name('dashboard.statusleads');
Route::get('/leads/substatusgraphleads/{substatusid}', [DashboardController::class, 'substatusgraphleads'])->name('dashboard.substatusgraphleads');
Route::get('/leads/callbackleads/{userid}/{substatusid}',[DashboardController::class, 'callbackleads'])->name('dashboard.callbackleads');
Route::get('/leads/budgetuserwise/{userid/{budgetid}',[DashboardController::class, 'budgetuserwise'])->name('dashboard.budgetuserwise');
//Route::get('/leads/',);
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
        ...
        function () {
            Route::get('lead/create',[LeadController::class, 'addlead'])->name('lead.add');
            Route::post('lead/add',[LeadController::class, 'addcontact'])->name('lead.addlead');
            Route::get('lead-list',[LeadController::class, 'list'])->name('lead.list');
            Route::post('/leads/assign', [LeadController::class, 'assign'])->name('lead.assign');
            Route::get('lead/import/',[LeadController::class, 'leadsimport'])->name('leads.import');
            ...
            Route::get('lead/edit/{id}',[LeadController::class,'editlead'])->name('lead.edit');
            ...
            Route::get('lead/view/{id}',[LeadController::class,'leadview'])->name('lead.view');
            Route::post('/leads/import', [LeadController::class, 'importleads'])->name('leads.import.store');
            Route::post('/lead/interested/{id}',[LeadController::class, 'updateLeadStatusInterested'])->name('leads.status.interested');
            Route::post('/lead/notinterested/{id}',[LeadController::class, 'updateLeadStatusNotinterested'])->name('leads.status.notinterested');
            Route::post('/lead/callback/{id}',[LeadController::class, 'callback'])->name('leads.status.callback');
            Route::post('/lead/lostLead/{id}',[LeadController::class, 'lostLead'])->name('leads.status.lostLead');
            Route::post('/lead/taskRescheduled/{id}',[LeadController::class, 'taskRescheduled'])->name('leads.status.taskRescheduled');
            Route::post('/lead/taskCreate/{id}',[LeadController::class, 'taskCreate'])->name('leads.status.taskCreate');
            Route::post('/lead/wonLead/{id}',[LeadController::class,'wonLead'])->name('leads.status.wonLead');
            ...
            Route::get('/create-booking/{id}',[LeadController::class,'createBooking'])->name('lead.create.booking');
            Route::post('/booking/store/',[LeadController::class,'storeBooking'])->name('booking.store');
            Route::get('/booking/list', [LeadController::class, 'bookinglist'])->name('bookings.index');
...
Route::get('/budgets', [ResourcesController::class, 'budgetlist'])->name('budget.list');
Route::get('/budgets/create', [ResourcesController::class, 'create'])->name('budget.create');
Route::post('/budgets/store', [ResourcesController::class, 'store'])->name('budget.store');
Route::get('/budgets/edit/{id}', [ResourcesController::class, 'edit'])->name('budget.edit');
Route::post('/budgets/update/{id}', [ResourcesController::class, 'update'])->name('budget.update');
Route::delete('/budgets/delete/{id}', [ResourcesController::class, 'destroy'])->name('budget.delete');
